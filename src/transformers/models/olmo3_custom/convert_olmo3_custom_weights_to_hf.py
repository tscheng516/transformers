...
from transformers import AutoTokenizer, Olmo3CustomConfig, Olmo3CustomForCausalLM
...
```
python src/transformers/models/olmo3_custom/convert_olmo3_custom_weights_to_hf.py \
    --input_dir /path/to/downloaded/olmo3_custom/weights --model_size 7B --output_dir /output/path
```

Thereafter, models can be loaded via:

```py
from transformers import Olmo3CustomForCausalLM, AutoTokenizer

model = Olmo3CustomForCausalLM.from_pretrained("/output/path")
...
def write_model(
    ...
    model = Olmo3CustomForCausalLM.from_pretrained(tmp_model_path, dtype=torch.bfloat16)
