...
class Olmo3CustomConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Olmo3CustomModel`]. It is used to instantiate an OLMo3Custom
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 50304):
            Vocabulary size of the Olmo3Custom model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`Olmo3CustomModel`]
    ...
    >>> # Initializing a Olmo3Custom 7B style configuration
    >>> configuration = Olmo3CustomConfig()

    >>> # Initializing a model from the Olmo3Custom 7B style configuration
    >>> model = Olmo3CustomModel(configuration)
